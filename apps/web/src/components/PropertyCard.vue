<template>
  <div
    class="overflow-hidden rounded-2xl border border-neutral-800 bg-neutral-900 transition hover:border-neutral-700 cursor-pointer"
  >
    ...
    <div class="p-4">
      ...
      <p class="mt-2 font-medium text-white">
        AED {{ Intl.NumberFormat().format(item.price) }}
      </p>
